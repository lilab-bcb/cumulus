...
parser.add_argument('--min_merge_fraction')
parser.add_argument('--max_cb_merge_edit_distance')
parser.add_argument('--max_umi_merge_edit_distance')
parser.add_argument('--min_genes_before_merge')
parser.add_argument('--cb')
parser.add_argument('--umi')
parser.add_argument('--gene')
parser.add_argument('--cb_quality')
parser.add_argument('--umi_quality')
