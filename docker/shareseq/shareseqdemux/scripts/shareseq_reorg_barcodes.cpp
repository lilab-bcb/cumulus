...
int main(int argc, char* argv[]) {
	if (argc < 3) {
		printf("Usage: shareseq_reorg_barcodes barcode_index.csv max_mismatch\n");
	...
	max_mismatch = atoi(argv[2]);
	printf("Load barcode indices.\n");
	parse_sample_sheet(argv[1], n_barcode, barcode_len, barcode_index, barcode_names, max_mismatch);
