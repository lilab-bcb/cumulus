	...
	.. list-table::
		...
		* - **Index**
		  - 
			...
			| Note that all index sequences (including 10x's) should have the same length (8 bases). If one index sequence is shorter (e.g. CGTGAT), pad it with 'N's (e.g. CGTGATNN).
		* - Chemistry
		  - 
