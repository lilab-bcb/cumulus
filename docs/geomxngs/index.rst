...
**geomxngs_dcc_to_count_matrix** workflow takes the DCC zip file from **geomxngs_fastq_to_dcc** and other files produced by the GeoMx DSP machine as inputs, and outputs an area of illumination (AOI) by probe count matrix with patholgoists' annotation.
